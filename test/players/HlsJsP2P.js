...
import FilePlayer from '../../src/players/HlsJsP2P'
import { defaultProps } from '../../src/props'
import * as utils from '../../src/utils'
import HlsJsP2P from '../../src/players/HlsJsP2P'
...
test.beforeEach(t => {
  HlsJsP2P.prototype.componentWillMount = function () {
    this.ref({
...
test.afterEach(t => {
  HlsJsP2P.prototype.componentWillMount = undefined
})

test('listeners', t => {
  const addListeners = sinon.spy(HlsJsP2P.prototype, 'addListeners')
  const removeListeners = sinon.spy(HlsJsP2P.prototype, 'removeListeners')
